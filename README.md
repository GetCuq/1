...
- Удалённый VPS сервер на Linux для запуска OlcRTC сервера, чтобы вам было куда собственно подключаться (Как это сделать также описано в оригинальном репозитории OlcRTC)
---
